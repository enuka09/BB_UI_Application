...
<div class="container2">
    <form class="form" action="${pageContext.request.contextPath}/insertProduct" method="post"
        ...
        <div class="button-container">
            ...
            <button class="back-button" onclick="window.location.href = 'ManageProducts.jsp'; return false;">Back
            </button>
        </div>
