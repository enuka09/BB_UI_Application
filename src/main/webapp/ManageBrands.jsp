...
<div class="container">
    <div class="sidebarnew">
        ...
        <div class="selected-icon">
            <i class='fa-solid fa-ring' style="margin-left: 15px; margin-top: 30px"></i><span
                style='display:inline-block; margin-left: 10px; margin-top: -100px; color: #ffffff;'>Manage Brands</span>
        </div>
...
<div class="main-body">
    ...
    <div class="promo_card">
        <h1 style="margin-left:0px;">BRAND DETAILS</h1>
    </div>
    <div class="control-btn">
        <button class="add_brand_btn" onclick="window.location.href = 'AddBrand.jsp'">Add New Brand</button>
...
<table>
    ...
    <tr class="border-bottom border-top">
        <th class="border-right">Brand ID</th>
        <th class="border-right">Brand Name</th>
...
<div class="edit-form" id="editBrandModal" style="display:none">
    <h2 style="margin-bottom: 30px; padding-top: 30px">Edit Brand</h2>
    <form id="editBrandForm" action="${pageContext.request.contextPath}/editBrand" method="POST">
        <label for="brandId">Brand ID:</label>
        <input type="text" id="brandId" name="brandId"><br><br>
        <label for="brandName" style="background: none; border: #959595;">Brand Name:</label>
        <input type="text" id="brandName" name="brandName" style="border: 1px solid black; padding-left: 10px;">
        <button type="submit" id="saveBrandBtn" name="saveBrandBtn" class="save-btn">Save</button>
        <button type="button" id="cancelBrandBtn" class="cancel-btn">Cancel</button>
    </form>
</div>
    ...
    function loadBrand() {
        ...
        xhttp.onreadystatechange = function () {
            if (this.readyState == 4 && this.status == 200) {
                var brandData = JSON.parse(this.responseText);
                var brandTable = document.getElementById("brandTable");
                brandTable.innerHTML = "";
                for (var i = 0; i < brandData.length; i++) {
                    var row = brandTable.insertRow(i);
                    var idCell = row.insertCell(0);
                    var nameCell = row.insertCell(1);
                    var actionsCell = row.insertCell(2);
                    idCell.innerHTML = brandData[i].id;
                ...
                $(".del_brand_btn").click(function () {
                    var id = $(this).data("id");
                    if (confirm("Are you sure you want to Delete this Brand?")) {
                        $.ajax({
                            url: "http://localhost:8080/BB_REST_APP-1.0-SNAPSHOT/api/brands/delete/" + id,
                            type: "DELETE",
                            success: function () {
        ...
        xhttp.open("GET", "http://localhost:8080/BB_REST_APP-1.0-SNAPSHOT/api/brands", true);
        xhttp.send();
    }
