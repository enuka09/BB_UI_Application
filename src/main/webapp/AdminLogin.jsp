...
<head>
    ...
    <link href="https://fonts.googleapis.com/css2?family=Montserrat:ital,wght@0,400;0,700;0,800;1,400;1,700;1,800&display=swap"
          rel="stylesheet">
...
<div class="container">
    <div class="form-container">
        <form class="form" action="${pageContext.request.contextPath}/admin-login" method="post">
            ...
            <input type="password" name="password" id="txtloginpassword" class="form-input" placeholder="Password"
                   required>
